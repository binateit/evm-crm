...
export default function ApprovedOrdersPage() {
  ...
  useEffect(() => {
    async function fetchOrders() {
      ...
      try {
        setLoading(true);
        // Fetch orders with Approved status (statusId = 4) or Distributor Approved (statusId = 3)
  ...
  const breadcrumbItems = [
    ...
    { label: "Approved", url: "/orders/approved" },
  ];
  ...
  return (
    <div className="space-y-4">
      ...
      <PageHeader title="Approved Orders" subtitle="Orders that have been approved" />
